...
Usage:
    python docs/build_docs.py [output_dir]
...
# Ensure the project root (parent of docs/) is on sys.path and is the cwd
...
def generate_controller_docs_module(generated_maps):
    ...
    lines = [
        '"""Controller Maps',
        '',
        'Auto-generated by ``docs/build_docs.py``. Do not edit manually.',
        '',
