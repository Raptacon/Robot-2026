...
_MODULE_LOCATIONS = [
    (SwerveDriveConsts.moduleFrontLeftX, SwerveDriveConsts.moduleFrontLeftY),
    (SwerveDriveConsts.moduleFrontRightX, SwerveDriveConsts.moduleFrontRightY),
    (SwerveDriveConsts.moduleBackLeftX, SwerveDriveConsts.moduleBackLeftY),
    (SwerveDriveConsts.moduleBackRightX, SwerveDriveConsts.moduleBackRightY),
]
