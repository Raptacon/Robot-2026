...
motorIdNameMap = {
    ...
    drivetrain.kLeftMotorID: "DriveLeft",
    drivetrain.kRightMotorID: "DriveRight",
}
...
class MyRobot(TimedCommandRobot):
    def robotInit(self):
        ...
        # Default arcade drive: left stick Y = forward, right stick X = rotation
